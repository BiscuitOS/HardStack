...
static int __init BiscuitOS_init(void)
{
	...
	/* IOREMAP with WriteCombining */
	mem = ioremap_wc(BROILER_MEM_BASE, BROILER_MEM_LEN);
	if (!mem) {
...
MODULE_DESCRIPTION("WriteCombining with Memory on BiscuitOS");
