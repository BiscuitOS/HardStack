/*
 * WriteCombining(WC) Memory on Kernel
 *
...
static int __init BiscuitOS_init(void)
{
	...
	/* Set virtual address as WriteCombining(WC) */
	set_memory_wc((unsigned long)addr, PAGE_SIZE);
...
MODULE_DESCRIPTION("WriteCombining(WC) Memory on BiscuitOS");
