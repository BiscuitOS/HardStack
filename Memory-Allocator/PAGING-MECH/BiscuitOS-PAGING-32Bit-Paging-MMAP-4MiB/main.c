...
#ifndef __i386__
#error "Must Running on Intel i386"
#endif

#define SPECIAL_DEV_NAME	"BiscuitOS-PageTable"
#define I386_HPAGE_SIZE		(4 * 1024 * 1024)
                         ...
                         unsigned long next, struct mm_walk *walk)
{
	...
	/* Check PMD Entry is Empty, Address must alignment 4MiB */
	...
	spin_unlock(ptl);
	printk("Build 4MiB Page Mapping.\n");
		...
		unsigned long pgoff, unsigned long flags)
{
	...
	align_addr = current->mm->get_unmapped_area(NULL, 0,
			len + I386_HPAGE_SIZE, 0, flags);
	/* Aligned on 4MiB */
	align_addr = round_up(align_addr, I386_HPAGE_SIZE);
