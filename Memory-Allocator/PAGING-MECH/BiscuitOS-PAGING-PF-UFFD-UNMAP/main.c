...
/*
 * PageFault with Userfaultfd on UNMAP
 *
...
int main()
{
	...
	if ((uffdio_api.features & UFFD_FEATURE_EVENT_UNMAP) == 0)
		errExit("Don't Support UFFD_FEATURE_EVENT_UNMAP");
