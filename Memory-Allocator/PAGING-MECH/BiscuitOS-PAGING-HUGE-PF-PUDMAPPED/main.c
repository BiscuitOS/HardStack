...
/*
 * Huge-PageFault - PUDMAPPED
 *
 *   Add "memmap=1G$4G" into CMDLINE
 *
...
#define SPECIAL_DEV_NAME	"BiscuitOS-HUGEPFN"
#define PFN_PHYSADDR		0x100000000 /* 4Gig */
...
MODULE_DESCRIPTION("HUGE PageFault");
