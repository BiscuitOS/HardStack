...
#define MEMBLOCK_FAKE_REGION0	0x800000000
#define MEMBLOCK_FAKE_REGION1	0x800000000
#define MEMBLOCK_FAKE_REGION2	0x800200000
...
int __init BiscuitOS_Running(void)
{
	...
	/* Add new range */
	memblock_add(MEMBLOCK_FAKE_REGION0, MEMBLOCK_FAKE_SIZE * 3);
	...
	memblock_mark_hotplug(MEMBLOCK_FAKE_REGION1, MEMBLOCK_FAKE_SIZE);
	memblock_mark_hotplug(MEMBLOCK_FAKE_REGION2, MEMBLOCK_FAKE_SIZE);
	...
	memblock_remove(MEMBLOCK_FAKE_REGION0, MEMBLOCK_FAKE_SIZE * 3);
