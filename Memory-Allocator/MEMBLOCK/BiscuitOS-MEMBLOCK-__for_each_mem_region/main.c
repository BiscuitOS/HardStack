/*
 * MEMBLOCK Memory Allocator: __for_each_mem_range
 *
...
int __init BiscuitOS_Running(void)
{
	...
	/* Itereate over reserved regions on special NUMA NODE */
	printk("==== Iterate Memory Region on NUMA %d\n", MEMBLOCK_FAKE_NODE);
