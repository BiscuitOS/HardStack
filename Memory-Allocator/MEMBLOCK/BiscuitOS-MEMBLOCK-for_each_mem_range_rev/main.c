/*
 * MEMBLOCK Memory Allocator: for_each_mem_range_rev
 *
...
int __init BiscuitOS_Running(void)
{
	...
	/* Itereate Memory Region */
	printk("==== Iterate Memory Region\n");
	for_each_mem_range(idx, &region_start, &region_end)
		printk("REGION %#llx - %#llx\n", region_start, region_end);

	/* Reserve Itereate Memory Region */
	printk("==== Reserve Iterate Memory Region\n");
	for_each_mem_range_rev(idx, &region_start, &region_end)
		printk("REGION %#llx - %#llx\n", region_start, region_end);
