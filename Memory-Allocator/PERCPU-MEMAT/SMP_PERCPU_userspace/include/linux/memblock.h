...
extern void * memblock_alloc_try_nid_nopanic(
				phys_addr_t size, phys_addr_t align,
				phys_addr_t min_addr, phys_addr_t max_addr,
				int nid);

static inline void *memblock_alloc_from_nopanic(phys_addr_t size,
						phys_addr_t align,
...
static inline void *memblock_alloc_nopanic(phys_addr_t size,
					   phys_addr_t align)
{
