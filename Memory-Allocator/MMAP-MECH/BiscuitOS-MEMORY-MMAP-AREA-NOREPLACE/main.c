...
static void *alloc_memory(unsigned long addr, unsigned long size, int flags)
{
...
int main()
{
	...
	mem1 = (unsigned long)alloc_memory(MAP_VADDR1, MAP_SIZE, 0);
	mem2 = (unsigned long)alloc_memory(MAP_VADDR2, 
					   MAP_SIZE, MAP_FIXED_NOREPLACE);
