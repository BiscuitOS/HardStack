...
mount_fs()
{
	insmod /lib/modules/$(uname -r)/extra/minix.ko
	lsmod
	[ -d /minix_bs ] && rm -rf /minix_bs
	mkdir -p /minix_bs
	mount_common-0.0.1 -n BiscuitOS_minix -d /minix_bs -t minix_bs -f MS_SILENT -o size=8M
	cd /minix_bs
