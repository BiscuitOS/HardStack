...
static void __exit proc_root_exit_bs(void)
{
	unregister_filesystem(&proc_fs_type_bs);
}

module_init(proc_root_init_bs);
module_exit(proc_root_exit_bs);

MODULE_LICENSE("GPL");
MODULE_AUTHOR("BiscuitOS <buddy.zhang@aliyun.com>");
MODULE_DESCRIPTION("proc_bs filesystem");
