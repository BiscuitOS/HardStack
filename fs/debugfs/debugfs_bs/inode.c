...
static void __exit debugfs_exit_bs(void)
{
	unregister_filesystem(&debug_fs_type_bs);
}

module_init(debugfs_init_bs);
module_exit(debugfs_exit_bs);

MODULE_LICENSE("GPL");
MODULE_AUTHOR("BiscuitOS <buddy.zhang@aliyun.com>");
MODULE_DESCRIPTION("debugfs_bs filesystem");
