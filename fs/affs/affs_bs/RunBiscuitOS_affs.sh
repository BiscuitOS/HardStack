...
mount_fs()
{
	insmod /lib/modules/$(uname -r)/extra/affs.ko
	lsmod
	[ -d /affs_bs ] && rm -rf /affs_bs
	mkdir -p /affs_bs
	mount_common-0.0.1 -n BiscuitOS_affs -d /affs_bs -t affs_bs -f MS_SILENT -o size=8M
	cd /affs_bs
