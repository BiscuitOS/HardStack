/*
 * sysfs: sysfs_delete_link
 *
 * int sysfs_delete_link(struct kobject *kobj, struct kobject *target,
 *                                     const char *name)
 *
...
static int __init Demo_init(void)
{
    ...
    /* Remove symlink in kobject's directory */
    sysfs_delete_link(kobj, &devices_kset->kobj, "parent");
