...
static __exit void sysfs_exit_bs(void)
{
	unregister_filesystem(&sysfs_fs_type_bs);
}

module_init(sysfs_init_bs);
module_exit(sysfs_exit_bs);

MODULE_LICENSE("GPL");
MODULE_AUTHOR("BiscuitOS <buddy.zhang@aliyun.com>");
MODULE_DESCRIPTION("sysfs_bs filesystem");
