...
mount_fs()
{
	insmod /lib/modules/$(uname -r)/extra/sysfs.ko
	lsmod
	[ -d /sysfs_bs ] && rm -rf /sysfs_bs
	mkdir -p /sysfs_bs
	mount_common-0.0.1 -n BiscuitOS_sysfs -d /sysfs_bs -t sysfs_bs -f MS_SILENT -o size=8M
	cd /sysfs_bs
