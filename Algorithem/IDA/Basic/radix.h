...
extern void radix_tree_iter_replace(struct radix_tree_root *root,
			const struct radix_tree_iter *iter,
			void **slot, void *item);
extern void **idr_get_free(struct radix_tree_root *root,
			struct radix_tree_iter *iter, gfp_t gfp,
			unsigned long max);
extern int radix_tree_tagged(const struct radix_tree_root *root, 
			unsigned int tag);
extern void radix_tree_iter_tag_clear(struct radix_tree_root *root,
			const struct radix_tree_iter *iter, unsigned int tag);
extern void **idr_get_free(struct radix_tree_root *root,
			struct radix_tree_iter *iter, gfp_t gfp,
			unsigned long max);
extern void idr_preload(gfp_t gfp_mask);
extern int radix_tree_tag_get(const struct radix_tree_root *root,
			unsigned long index, unsigned int tag);
extern void *__radix_tree_lookup(const struct radix_tree_root *root,
			unsigned long index, struct radix_tree_node **nodep,
			void ***slotp);
extern void __radix_tree_replace(struct radix_tree_root *root,
			struct radix_tree_node *node,
			void **slot, void *item,
			radix_tree_update_node_t update_node);
extern int __radix_tree_preload(gfp_t gfp_mask, unsigned nr);
extern void radix_tree_iter_delete(struct radix_tree_root *root,
			struct radix_tree_iter *iter, void **slot);
extern void radix_tree_iter_tag_set(struct radix_tree_root *root,
			const struct radix_tree_iter *iter, unsigned int tag);
