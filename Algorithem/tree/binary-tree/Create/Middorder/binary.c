...
static int Perfect_BinaryTree_data[] = { 
                                   -1, 6, -1, 754, -1, 3, -1, 143, -1, 7,
                                   -1, 386, -1, 9, -1, 200, -1, 8, -1,
                                   486, -1, 2, -1, 876, -1, 1, -1, 740,
                                   -1, 5, -1 };
...
static struct binary_node *Middorder_Create_BinaryTree(struct binary_node *node)
{
	/* Note! Middorder can't create binary-tree! */
	...
	if (ch == -1) {
		...
		Middorder_Create_BinaryTree(node->left);
		node->idx = ch;
		Middorder_Create_BinaryTree(node->right);
	}
}
...
int main()
{
	...
	BiscuitOS_root = Middorder_Create_BinaryTree(BiscuitOS_root);
