...
static void BiscuitOS_dma_timer(void *opaque)
{
	...
	if (bps->dma.dir == PCI_TO_DDR) { /* TLP Memory Read */
		...
		printf("[QEMU GPUB NV A100s] %s", bps->dma_buffer);
	}
