...
#define EMBEDDED_NAME_MAX	4080
static char filepath[8192];

int main()
{
	/* Setup filepath */
	memset(filepath, 'B', 8192);

	/* Pathlength == EMBEDDED_NAME_MAX */
	filepath[EMBEDDED_NAME_MAX] = '\0';

	BiscuitOS_open(filepath, O_RDWR);
	return 0;
}
